...
class ib : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewQuiz.setOnClickListener { openPdf("quiz_bio") }
        textViewMinor1.setOnClickListener { openPdf("minor1_bio") }
        textViewMinor2.setOnClickListener { openPdf("minor2_bio") }
        textViewMajor.setOnClickListener { openPdf("major_bio") }
        textViewProfessor.setOnClickListener { openPdf("professor_bio") }
        textViewNotes.setOnClickListener { openPdf("notes_bio") }
    }
