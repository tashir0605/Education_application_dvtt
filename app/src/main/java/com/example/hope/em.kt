...
class em : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewQuiz.setOnClickListener { openPdf("quiz_em") }
        textViewMinor1.setOnClickListener { openPdf("minor1_em") }
        textViewMinor2.setOnClickListener { openPdf("minor2_em") }
        textViewMajor.setOnClickListener { openPdf("major_em") }
        textViewProfessor.setOnClickListener { openPdf("professor_em") }
        textViewNotes.setOnClickListener { openPdf("notes_em") }
    }
